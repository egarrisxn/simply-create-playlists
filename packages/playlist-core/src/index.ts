...
//   const tokens = await authorizeWithPkce(options.spotify);
...
//     if (replace) {
//       console.log("Replacing: clearing existing playlist first...");
//       await clearPlaylist(tokens.access_token, playlistId);
//     } else if (!append) {
//       console.log(
//         "append=false detected without --replace; clearing playlist first..."
//       );
...
//     await addTracks(tokens.access_token, playlistId, toAdd);
//     console.log(`OK (${toAdd.length} tracks)`);
//   }
